...
// The root page doesn't seem to use the title template from the layout, so we set it explicitly here.
export const metadata: Metadata = { title: `Home | ${process.env.SITE_NAME}` }
